...
<body>
        ...
        <a href="index.php" style="color:black;"><i class="fa fa-arrow-left" style="font-size:24px; float:left;"></i></a>
           <span style="font-size:20px;"> TATLİLAR</span>
        </div>
        <div class="container">
...
$baglanti = new mysqli('localhost', 'arminsca_olmezses', 'Mmo12345#.', 'tatlilar');
                        ...
                        $sonuc=mysqli_query($baglanti,"SELECT *FROM tatlilar");
